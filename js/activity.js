define(["sugar-web/activity/activity" , "sugar-web/env", "sugar-web/graphics/icon", "webL10n", "sugar-web/graphics/presencepalette", "sugar-web/datastore", "sugar-web/graphics/journalchooser"], function (activity, env) {
	...
	require(['domReady!'], function (doc) {
		...
		palette.addEventListener('shared', function() {
			...
			presence = activity.getPresenceObject(function(error, network) {
				...
				network.createSharedActivity('org.sugarlabs.Pawns', funciton(groupId) {
					console.log("Activity shared");
					isHost = true;
				});
				network.onDataReceived(onNetworkDataReceived);
